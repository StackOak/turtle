...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        workerId = workerIdAssigner.assignWorkerId()
                .doOnNext(id -> {
                    if (id > bitsAllocator.getMaxWorkerId()) {
                        throw new RuntimeException("Worker id " + id + " exceeds the max " + bitsAllocator.getMaxWorkerId());
                    }
                    LOGGER.info("Initialized bits(1, {}, {}, {}) for workerID:{}", timeBits, workerBits, seqBits, id);
